                            ...
                            <div class="grid gap-6 w-full md:w-1/2">
                                    ...
                                    <x-form.select :id="__('user_type_id')" :name="__('user_type_id')">
                                        @foreach ($userTypes as $userType)
                                            <option value="{{ $userType->id }}"
                                                {{ $product->user_type_id == $userType->id ? 'selected' : '' }}>
                                                {{ $userType->type_name }}
                                            </option>
                                        @endforeach
                                    </x-form.select>
                                ...
                                <div class="space-y-2">
                                    ...
                                    <x-form.input-with-icon-wrapper>
                                        ...
                                        <textarea name="description" id="description" rows="4" class="block w-full" placeholder="{{ __('Description') }}">{{ old('description', $product->description) }}</textarea>
                                    </x-form.input-with-icon-wrapper>
                                ...
                                <div class="space-y-2">
                                    ...
                                    <x-form.select :id="__('currency')" :name="__('currency')">
                                        ...
                                        <option value="IDR" {{ $product->currency == 'IDR' ? 'selected' : '' }}>IDR</option>
                                ...
                                <div class="space-y-2">
                                    ...
                                    <x-form.input-with-icon-wrapper>
                                        ...
                                        <x-form.input withicon id="price" class="block w-full" type="number"
                                            step="0.01" name="price" :value="old('price', $product->price)" required
                                ...
                                <div class="space-y-2">
                                    ...
                                    <x-form.input-with-icon-wrapper>
                                        ...
                                        <x-form.input withicon id="quota" class="block w-full" type="number"
                                            name="quota" :value="old('quota', $product->quota)" required
